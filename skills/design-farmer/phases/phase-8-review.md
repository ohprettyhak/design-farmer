...
5. If user chose A or B: proceed to Phase 8.5 (independent verification method). If user chose C: re-run reviewer delegation from Step 1 (do NOT proceed to Phase 8.5 until reviewers complete or fail again).
