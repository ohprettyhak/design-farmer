...
3. **Preserve** the extraction data from Phase 3 (colors, typography, spacing) — merge with Phase 4/4b decisions rather than regenerating from scratch. **Conflict resolution:** if Phase 3 draft data conflicts with Phase 4/4b decisions (e.g., dark mode color values adjusted during preview approval), Phase 4/4b values take precedence — they reflect user-approved adjustments.
